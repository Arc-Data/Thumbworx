<template>
  ...
  <div class="flex min-h-screen bg-background-default">
    <div class="hidden md:block w-[600px] bg-primary-200"></div>
    <div class="flex-1 px-4 py-10 bg-primary-1 00 ">
      ...
      <div class="container max-w-2xl mx-auto mt-4">
        <ol class="flex items-center justify-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
            <li class="flex md:w-full items-center text-primary-default dark:text-blue-500 sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
                <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-accent-default ">
      ...
      <div class="px-8 md:px-20">
        ...
        :errors="errors.value"
        :disabled="disabled"
        @submit-step1="handleStep1"></step1>
      </div>
    </div>
  </div>
</template>

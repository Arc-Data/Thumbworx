...
<div class="flex flex-col w-full">
    ...
    <div class="w-full text-black">
      <div class="flex justify-center  sm:-mx-6 lg:-mx-8">
        <div class="inline-block w-11/12 py-2 mx-6 my-10 text-black border-solid  sm:px-6 lg:px-8 lg:w-auto h-fit rounded-2xl border-slate-500 drop-shadow-md bg-blue-50">
                        ...
                        <form class="w-1/2 ">   
                            <div class="relative">
                                <div class="absolute inset-y-0 flex items-center pointer-events-none start-0 ps-3">
                                    <svg class="w-4 h-4 text-gray-500:t " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          ...
          <div class="px-4">
            <br>
            <h2 class="ml-1 text-lg font-bold tracking-wide  md:text-xl lg:text-xl xl:text-xl"><i class="icon pi pi-folder-open"></i> Helper Account Records</h2>
            <br>
            ...
            <div class="overflow-hidden overflow-x-auto">
              ...
              <tbody>
                ...
                <tr v-for="user in result" v-bind:key="user.id" 
                  class="transition duration-300 ease-in-out border-b  dark:hover:bg-slate-700 border-neutral-200 hover:bg-blue-100">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap"><button class="btn btn-primary" @click="viewDriverDetails(user.id)"><span class="material-icons">visibility</span></button> </td>
              </tr>
              </tbody>
            </table>
            </div>
    ...
    <div id="helperDetailsPop" class="fixed top-0 left-0 z-50 flex justify-center w-screen h-screen pt-10 bg-black bg-opacity-50 collapse">
       <!-- pop up content div -->
       <div class="w-11/12 max-w-screen-md bg-white rounded-lg drop-shadow-lg border-1 border-slate-400 h-fit ">  
           <div class="flex items-center pl-4 pr-2 font-bold text-white bg-blue-600 rounded-tl-lg rounded-tr-lg "> 
                            <legend class="self-center">Helper Details</legend>
                            <!-- close btn -->

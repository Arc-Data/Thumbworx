...
<div class="flex flex-col w-full">
  ...
  <div class="flex flex-col w-full">
    <div class="sm:-mx-6 lg:-mx-8 flex justify-center text-black">
      <div class="inline-block py-2 sm:px-6 lg:px-8 w-11/12 mx-6 lg:w-auto h-fit
      ...
      ">
        ...
        <!-- tablecontainer -->
                  <div class="block">
                    ...
                    absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                      <div class="" role="none">
        ...
        md:text-xl
        lg:text-xl
        xl:text-xl font-bold tracking-wide ml-4"><i class="icon pi pi-folder-open"></i> Driver Account Records</h2>
          ...
          <div class="overflow-hidden overflow-x-auto">
              ...
              <tbody>
                ...
                <tr v-for="user in result" v-bind:key="user.id" 
                  ...
                  <td class="whitespace-nowrap px-4 py-4"><button class="btn btn-primary text-white" @click="viewDriverDetails(user.id)"><span class="material-icons">visibility</span></button> </td>
              </tr>
  ...
  <div id="driverDetailsPop" class="
  
  collapse
  w-screen h-screen fixed top-0 left-0 z-50 bg-black bg-opacity-50 flex justify-center pt-10">
     <!-- pop up content div -->
     <div class="rounded-lg drop-shadow-lg border-1 border-slate-400 bg-white max-w-screen-md w-11/12 h-fit ">  
      <!-- popup header --> 
        ...
        drop-shadow-lg">
          ...
          rounded-tl-lg rounded-tr-lg p-3 text-xl bg-slate-200">
              <h6>Personal Information</h6>
          </div>
          <!-- body -->
          <div class="
          
          rounded-bl-lg rounded-br-lg p-3 bg-slate-100">
              ...
              <div class="mb-3 mx-2 w-full lg:w-48"></div>

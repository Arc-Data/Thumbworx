      ...
      <div class="sm:-mx-6 lg:-mx-8 flex justify-center">
        ...
        my-10 rounded-2xl border-solid border-slate-500 drop-shadow-md bg-blue-50">
          ...
          <div class="px-4">
            ...
            md:text-xl
            lg:text-xl
            xl:text-xl font-bold tracking-wide ml-4"> <i class="icon pi pi-book"></i> Booking</h2>
            <br>
          ...
          <span class="material-icons">arrow_forward_ios</span>
            ...
            <div class="rounded-lg drop-shadow-lg border-1 border-slate-400 bg-white max-w-screen-md w-11/12 h-fit ">     <!-- popup header --> 
                          ...
                          <div class=" drop-shadow-lg">
                            ...
                            <!-- body -->
                            <div class=" rounded-bl-lg rounded-br-lg p-3 bg-slate-100 ml-auto mr-auto">
                                ...
                                <div class="mb-3 mx-2 w-full lg:w-48">
                                  ...
                                  <input
                                    ...
                                    id="disabledTextInput1"
                                     class=" w-full p-2 rounded-md border border-slate-300"
                                    disabled
                                    :value="9"
                                  />
                                </div>
...
export default { //provides a more modular and organized way to define multiple data properties within a component
  ...
  mounted() {
     // DOM manipulation should be done in the mounted hook

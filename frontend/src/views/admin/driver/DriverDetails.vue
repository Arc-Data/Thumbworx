    ...
    <div class="w-full ">
      <div class="flex justify-center sm:-mx-6 lg:-mx-8">
        <div class="inline-block w-11/12 py-2 mx-6 my-10 text-black border-solid sm:px-6 lg:px-8 lg:w-auto h-fit rounded-2xl border-slate-500 drop-shadow-md bg-blue-50">
          ...
          <div class="px-4">
            <br>
            <h2 class="ml-4 text-lg font-bold tracking-wide md:text-xl lg:text-xl xl:text-xl"> <i class="icon pi pi-book"></i> Booking</h2>
            <br>
      ...
      <div class="flex justify-between w-full p-4 border-t border-blue-gray-50">
        ...
        <button
          ...
          <span class="material-icons">arrow_forward_ios</span>
            ...
            <!-- pop up content div -->
            <div class="w-11/12 max-w-screen-md bg-white rounded-lg drop-shadow-lg border-1 border-slate-400 h-fit ">     <!-- popup header --> 
                          ...
                          <div class=" drop-shadow-lg">
                            ...
                            <!-- body -->
                            <div class="p-3 ml-auto mr-auto rounded-bl-lg rounded-br-lg bg-slate-100">

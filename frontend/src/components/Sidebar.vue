<template> 
	...
	<aside :class="is_expanded ? 'w-64' : 'w-24'" class="z-20 flex flex-col h-full p-4 transition-all duration-200 ease-in-out bg-primary-default dark:bg-primary-500 text-light">
  ...
  <ul id="dropdown-example" class="hidden py-2 space-y-2">
    <li>
      ...
      <ul id="dropdown-sub" class="hidden py-2 space-y-2">
        <li>
          <router-link to="/superadmin/drivers" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
        ...
        <li>
          <router-link to="/superadmin/drivers/bookings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Booking
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/drivers/ratings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">    
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Rating
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/drivers/logs" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Logs
            </span>
          </router-link>
	...
	<ul id="dropdown-helper" class="hidden py-2 space-y-2">
        <li> <router-link to="/superadmin/helpers" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Account
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/helpers/bookings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Booking
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/helpers/ratings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">    
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Rating
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/helpers/logs" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Logs
            </span>
          </router-link>
	...
	<ul id="dropdown-client" class="hidden py-2 space-y-2">
        <li> <router-link to="/superadmin/clients" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Account
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/clients/bookings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Booking
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/clients/ratings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">    
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Rating
            </span>
          </router-link>
        ...
        <li>
          <router-link to="/superadmin/clients/logs" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
            <span class="ml-4 transition-opacity duration-200 ease-in-out" :class="{'opacity-0': !is_expanded}">
              Logs
            </span>
          </router-link>

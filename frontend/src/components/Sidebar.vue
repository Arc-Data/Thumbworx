          ...
          <div>
              <ul class="font-medium ">
                <li>
                    ...
                    <span> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="flex-shrink-0 transition duration-75 w-7 h-7 text-cotton">
                    ...
                    <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">Dashboard</span>
                    </router-link>
                </li> <!--DASHBOARD-->
                ...
                <li>
                  <button
                    ...
                    <span>
                      <svg
                        class="flex-shrink-0 transition duration-75 w-7 h-7 text-cotton group-hover:text-gray-900"
                        aria-hidden="true"
                  ...
                  <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                      ...
                      <ul id="dropdown-sub" class="hidden py-2 space-y-2">
                        <li>
                          <router-link to="/admin/drivers" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                            <span class="mx-2 material-icons ">account_circle </span>
                            <span class="flex transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                               Account
                            </span>
                          </router-link>
                        </li>
                        <li>
                          <router-link to="/admin/drivers/bookings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                        ...
                        <li>
                          <router-link to="/admin/drivers/ratings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">    
                        ...
                        <li>
                          <router-link to="/admin/drivers/logs" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                  ...
                  <ul id="dropdown-helper" class="hidden py-2 space-y-2">
                        <li> <router-link to="/admin/helpers" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                          <span class="mx-2 material-icons ">account_circle </span>  
                          <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Account
                            </span>
                        ...
                        <li>
                          <router-link to="/admin/helpers/bookings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                            <span class="mx-2 material-icons ">library_books </span>
                            <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Booking
                            </span>
                        ...
                        <li>
                          <router-link to="/admin/helpers/ratings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">    
                        ...
                        <li>
                          <router-link to="/admin/helpers/logs" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                            <span class="mx-2 material-icons ">receipt_long </span>
                            <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Logs
                            </span>
                  ...
                  <ul id="dropdown-client" class="hidden py-2 space-y-2">
                        <li> <router-link to="/admin/clients" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                          <span class="mx-2 material-icons ">account_circle </span>  
                          <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Account
                            </span>
                        ...
                        <li>
                          <router-link to="/admin/clients/bookings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                            <span class="mx-2 material-icons ">library_books </span>
                            <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Booking
                            </span>
                        ...
                        <li>
                          <router-link to="/admin/clients/ratings" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">    
                            <span class="mx-2 material-icons ">stars </span>
                            <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Rating
                            </span>
                        ...
                        <li>
                          <router-link to="/admin/clients/logs" class="flex items-center p-2 transition duration-200 ease-in-out text-light hover:bg-dark-alt hover:text-primary">
                            <span class="mx-2 material-icons ">receipt_long </span>
                            <span class="transition-opacity duration-200 ease-in-out" :class="{'collapse': !is_expanded}">
                              Logs
                            </span>
